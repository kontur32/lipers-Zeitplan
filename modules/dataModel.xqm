          ...
          return
            <признак:имеетУчебноеЗанятие>
              <rdf:Description>
                  ...
                  <признак:названиеКласса>{$класс/text()}</признак:названиеКласса>
                  {
                    $ii/п:подгруппа/text() ?? <признак:названиеПодгруппы>{$ii/п:подгруппа/text()}</признак:названиеПодгруппы> !! ()
                  }
